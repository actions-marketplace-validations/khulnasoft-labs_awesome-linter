...
This folder holds automation scripts to help `deploy` and `cleanup` **DockerHub** images of the **Awesome-Linter**
...
- Build the **Docker** container for **Awesome-Linter** using that source code
...
This folder holds all **Test Cases** to help run the _CI/CT/CD_ process for the **Awesome-Linter**.
